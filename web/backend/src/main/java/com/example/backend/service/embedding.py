...
class WordVector():
    ...
    def get_word2vec_model(self):
        ...
        word2vec_model = gensim.models.Word2Vec.load(os.getcwd()+word2vec_path)
    ...
    def get_fasttext_model(self):
        ...
        fasttext_model = gensim.models.fasttext.load_facebook_model(os.getcwd()+fasttext_path)
    ...
    def get_glove_model(self):
        ...
        glove_model = dict()
        file = open(os.getcwd()+glove_path, encoding='utf8')
        for line in file:
